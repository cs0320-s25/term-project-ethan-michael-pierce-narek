...
public class FilterCourses {
  ...
  public static void main(String[] args) {
    try {
      ...
      String chemCoursesJson = filterCourses("202420", "CHEM", "9-9:50a", "MWF");
  ...
  public static String filterCourses(String term, String deptCode, String time, String day) throws IOException {
    ...
    if (data instanceof Map) {
      ...
      for (Object courseObj : allCourses) {
        ...
        if (courseTerm.equals(term) &&
            courseCode.startsWith(deptCode + " ") &&
            courseDay.equals(day) &&
            courseTime.equals(time) &&
            no.startsWith("S")) {
