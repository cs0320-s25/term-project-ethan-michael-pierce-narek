...
public class IsWRIT {
  ...
  private static final Map<String, String> COOKIES =
      Map.of(
          "AMCV_4D6368F454EC41940A4C98A6%40AdobeOrg",
              "179643557%7CMCIDTS%7C20146%7CMCMID%7C35620687361685143708671614397990958274%7CMCAID%7CNONE%7CMCOPTOUT-1740540362s%7CNONE%7CvVersion%7C5.5.0",
          "__zlcmid", "1QxnVZPFFXDFoMj",
          "acceptcookies", "false",
          "fcsid", "nosfgnrc57f8ur1ju0m0vvv5ap",
          "AMP_572175c4a8",
              "",
          "AMP_MKTG_572175c4a8",
          ...
          "amplitude_id_9f6c0bb8b82021496164c672a7dc98d6_edmbrown.edu",
              "eyJkZXZpY2VJZCI6IjdiNGEzZmQ2LTdjMmUtNGZjZC1iMzUxLTRjNTg1OTI1ODE5M1IiLCJ1c2VySWQiOm51bGwsIm9wdE91dCI6ZmFsc2UsInNlc3Npb25JZCI6MTc0NDY2MzMxODU5MywibGFzdEV2ZW50VGltZSI6MTc0NDY2MzMyMzg5OCwiZXZlbnRJZCI6MCwiaWRlbnRpZnlJZCI6MTUsInNlcXVlbmNlTnVtYmVyIjoxNX0=",
          "IDMSESSID",
              "5F4F6FE688A6974A45BB5DDF724B25B1D43F9B1F2904B921CD5E4D2BB297C5AC19E573A1A6BE903A2A963193973A2681",
          "TS01b3a32b",
              "014b44e76b2bfffa4bf11f672f482dda08cb75db42a613534f113167d5bf454488e2a1502795632863ba48809e01be925dd9ca685b");
  ...
  public static void main(String[] args) {
    try {
      // Example usage
      boolean isWritCourse = isClassWRIT("SOC 1020", "202420");
      System.out.println("Is WRIT designated: " + isWritCourse);
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
  ...
  /**
   * Checks if a course has the WRIT designation
   *
   * @param courseCode The course code (e.g., "SOC 1020")
   * @param term The term code (e.g., "202420")
   * @return true if the course has WRIT designation, false otherwise
   * @throws Exception if there's an error fetching course details
   */
  public static Boolean isClassWRIT(String courseCode, String term) throws Exception {
    ...
    Map<String, String> detailPayload =
        Map.of(
            "srcdb", srcdb,
            "crn", crn,
    ...
    // Check for WRIT designation in attr_html
    String attrHtml = (String) detailData.get("attr_html");
    if (attrHtml != null && attrHtml.contains("WRIT")) {
      return true;
    }
