...
public class UnitTesting {
  ...
  public void testParseMeetingDays() {
    assertEquals(Set.of("M", "W", "F"),
        SchedulerUtils.parseMeetingDays("MWF 10-10:50a"));

    assertEquals(Set.of("M","W"),
        SchedulerUtils.parseMeetingDays("MW 1-1:50p"));

    assertEquals(Set.of("T","Th"),
        SchedulerUtils.parseMeetingDays("TTh 2:30-3:50p"));

    assertEquals(Set.of("T"),
        SchedulerUtils.parseMeetingDays("T 1-2:20p"));
  }
  ...
  public void testHasTimeConflict() {
    assertTrue(SchedulerUtils.hasTimeConflict(
        courseWithMeetingTimes("[{\"meet_day\":\"1\",\"start_time\":\"1300\",\"end_time\":\"1420\"},{\"meet_day\":\"3\",\"start_time\":\"1300\",\"end_time\":\"1420\"}]"),
        courseWithMeetingTimes("[{\"meet_day\":\"1\",\"start_time\":\"1300\",\"end_time\":\"1420\"},{\"meet_day\":\"3\",\"start_time\":\"1300\",\"end_time\":\"1420\"}]")));

    assertFalse(SchedulerUtils.hasTimeConflict(
        courseWithMeetingTimes("[{\"meet_day\":\"1\",\"start_time\":\"1300\",\"end_time\":\"1420\"},{\"meet_day\":\"3\",\"start_time\":\"1300\",\"end_time\":\"1420\"}]"),
        courseWithMeetingTimes("[{\"meet_day\":\"0\",\"start_time\":\"1300\",\"end_time\":\"1350\"},{\"meet_day\":\"2\",\"start_time\":\"1300\",\"end_time\":\"1350\"},{\"meet_day\":\"4\",\"start_time\":\"1300\",\"end_time\":\"1350\"}]")));
  }

  @Test
  public void testArePrerequisitesSatisfied() {
    Map<String,Object> course = Map.of(
        "prereqGroups", List.of(
            List.of("MATH 0100", "CSCI 0150"),
            List.of("CSCI 0160")));
    List<String> taken = List.of("CSCI 0150", "CSCI 0160");
    assertTrue(SchedulerUtils.arePrerequisitesSatisfied(course, taken));

    Map<String,Object> course2 = Map.of(
        "prereqGroups", List.of(
            List.of("MATH 0100", "CSCI 0150"),
            List.of("CSCI 0160")
        ));
  ...
  public void parseMeetingTimes_singleBlock() {
    Map<String,Object> course = courseWithMeetingTimes("[{\"meet_day\":\"0\",\"start_time\":\"900\",\"end_time\":\"950\"},{\"meet_day\":\"2\",\"start_time\":\"900\",\"end_time\":\"950\"},{\"meet_day\":\"4\",\"start_time\":\"900\",\"end_time\":\"950\"}]");
  ...
  private static ScheduleGenerator generator(boolean needWrit, Set<String> allowedTimes) {
    ...
    return new ScheduleGenerator(3, List.of(), List.of(), List.of(),
        allowedTimes, days, new ScheduleGenerator.DayBalance(2,1),
        0, List.of(), needWrit);}
  ...
  private static Map<String,Object> makeCourse(String code, String meets, boolean writ) {
    ...
    String mtJson = String.format("[{\"meet_day\":\"0\",\"start_time\":\"%s\",\"end_time\":\"%s\"}]", start, end);

    return new HashMap<>(Map.of("code",  code, "title", "Mock " + code, "meets", meets,
        "writ",  writ, "meetingTimes", mtJson, "srcdb", "202420"));}
