...
function Home() {
  ...
  const dayOptions = {
    Monday: [
      "MWF 8-8:50a", "MWF 9-9:50a", "MWF 10-10:50a", "MWF 11-11:50a",
      "MWF 12-12:50p", "MWF 1-1:50p", "MWF 2-2:50p", "M 3-5:30p",
    ],
    Tuesday: [
      "TTh 9-10:20a", "TTh 10:30-11:50a", "TTh 1-2:20p", "TTh 2:30-3:50p",
      "TTh 6:40-8p", "T 4-6:30p",
    ],
    Wednesday: [
      "MWF 8-8:50a", "MWF 9-9:50a", "MWF 10-10:50a", "MWF 11-11:50a",
      "MWF 12-12:50p", "MWF 1-1:50p", "MWF 2-2:50p", "W 3-5:30p",
    ],
    Thursday: [
      "TTh 9-10:20a", "TTh 10:30-11:50a", "TTh 1-2:20p", "TTh 2:30-3:50p",
      "TTh 6:40-8p", "Th 4-6:30p",
    ],
    Friday: [
      "MWF 8-8:50a", "MWF 9-9:50a", "MWF 10-10:50a", "MWF 11-11:50a",
      "MWF 12-12:50p", "MWF 1-1:50p", "MWF 2-2:50p", "F 3-5:30p",
    ],
  };
              ...
              <>
                ...
                <div className="preferences-card">
                  ...
                  <div className="selected-tags">
                    ...
                    {course}
                          <button onClick={() =>
                              setRequiredClasses(requiredClasses.filter((_, i) => i !== idx))
                          }>
                      ×
                    </button>
                  </span>
                ...
                <div className="preferences-card">
                  ...
                  <div className="selected-tags">
                    ...
                    {dept}
                          <button onClick={() =>
                              setElectiveDepartments(electiveDepartments.filter((_, i) => i !== idx))
                          }>
                      ×
                    </button>
                  </span>
